...
######################################################################################
# The following code is NOT authored by the "Dipomado en Inteligencia Artificial" instructors,
# therefore, we use this code for purely pedagogical purposes, recognizing the authorship 
# and implicit value of the work donde by the original author.
#
# AUTHOR OF THE CODE: Jesús Vélez
# @jvelezmagic
#
# To find more information about the work of the author of this code, please visit the following link:
# https://github.com/jvelezmagic
#####################################################################################
